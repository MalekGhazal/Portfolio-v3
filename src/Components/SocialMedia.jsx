    ...
    <>
      <div className="flex items-center flex-col xl:flex-row justify-center lg:justify-around gap-3 w-3/4 lg:h-2/5">
        ...
        <div className="flex items-center justify-center gap-4">
          <FaLocationDot className="text-malek-dark md:text-3xl lg:text-5xl" />
          <p className="text-malek-green font-bungee-hairline text-stroke md:text-xl 2xl:text-3xl">
            Montreal, QC
          </p>
        </div>

        <div className="flex items-center justify-center gap-4">
          <FaEnvelope className="text-malek-dark md:text-3xl lg:text-5xl" />
          <p className="text-malek-green font-bungee-hairline text-stroke md:text-xl 2xl:text-3xl">
