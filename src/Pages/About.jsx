      ...
      <div className="bg-malek-green h-screen flex flex-col justify-center items-center gap-2">
        <div className="flex items-center flex-col lg:flex-row justify-center h-3/5">
          ...
          <p className="font-source-code w-4/5 lg:w-3/5 text-malek-white text-center md:text-start md:text-lg lg:text-xl xl:text-2xl xl:leading-relaxed">
            ...
            interface or a complex backend system. I&apos;ve dabbled in a bit of
            everything in the tech world, but where I really shine is in
            crafting solutions that are both effective and elegant. I&apos;m all
            about diving into new challenges with passion and determination,
            making sure every project I touch is not just good, but great.
            Let&apos;s team up and make some digital magic happen!
          </p>
        </div>
